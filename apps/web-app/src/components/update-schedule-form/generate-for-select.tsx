...
type GenerateForType = ScheduleConfigGenerateFor["type"];
type GenerateForValue = ScheduleConfigGenerateFor["value"];

export function GenerateForSelect({
  size = "sm",
  allowEveryone,
  organizationSlug,
  type,
  ...
  type: GenerateForType | undefined;
  value: GenerateForValue | undefined;
  onSelect: (type: GenerateForType | undefined, value: GenerateForValue | undefined) => void;
  id?: string;
  placeholder?: string;
}) {
          ...
          <div className="flex items-center gap-2">
            ...
            {type && (
              ...
              <div
                ...
                onClick={() => onSelect(type, undefined)}
              >
          ...
          <CommandList>
            ...
            {allowEveryone && (
              <CommandItem
                value="everyone"
                onSelect={() => {
                  onSelect("organization", organizationSlug);
                  setOpen(false);
                }}
              >
                ...
                <span>Everyone</span>
                <Check
                  className={cn("ml-auto", value === "organization" ? "opacity-100" : "opacity-0")}
                />
              </CommandItem>
            )}
