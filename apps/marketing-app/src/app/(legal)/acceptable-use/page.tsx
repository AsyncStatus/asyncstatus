...
export default function Page() {
  return (
    <LegalDocument>
      <LegalHeading>AsyncStatus Acceptable Use Policy</LegalHeading>
      <LegalParagraph>
        ...
        AsyncStatus under any ongoing agreement. It’s designed to protect us,
        our customers and the general Internet community from unethical,
        irresponsible and illegal activity.
      </LegalParagraph>
      <LegalParagraph>
        AsyncStatus customers found engaging in activities prohibited by this
      ...
      <LegalParagraph>
        This policy was last reviewed on March 10, 2025.
      </LegalParagraph>

      <LegalSubheading>Fair use</LegalSubheading>
      <LegalParagraph>
      ...
      <LegalSubheading>Customer accountability</LegalSubheading>
      <LegalParagraph>
      ...
      <LegalSubheading>Prohibited activity</LegalSubheading>
      <LegalSmallHeading>
      ...
      <LegalList ordered>
        ...
        <LegalListItem>Any violation of a person's privacy.</LegalListItem>
      </LegalList>
      <LegalParagraph>
      ...
      <LegalSmallHeading>
        Unauthorized use of AsyncStatus property
      </LegalSmallHeading>
      <LegalParagraph>
        We prohibit the impersonation of AsyncStatus, the representation of a
        significant business relationship with AsyncStatus, or ownership of any
        AsyncStatus property (including our Products and brand) for the purpose
        of fraudulently gaining service, custom, patronage or user trust.
      </LegalParagraph>

      <LegalSubheading>About this policy</LegalSubheading>
      <LegalParagraph>
