  ...
  return (
    <LegalDocument>
      ...
      <LegalParagraph>
        ...
        <a href="https://asyncstatus.com">https://asyncstatus.com</a>. This cookie policy is part of
        AsyncStatus's privacy policy. It covers the use of cookies between your device and our site.
      </LegalParagraph>
      <LegalParagraph>
      ...
      <LegalParagraph>
        ...
        cookies from <a href="https://asyncstatus.com">https://asyncstatus.com</a>. In such a case,
      ...
      <LegalParagraph>
        ...
        site to recognise your web browser when you return, additional data that serves the cookie’s
      ...
      <LegalSubheading>How Can You Control Our Website's Use of Cookies?</LegalSubheading>
      <LegalParagraph>
        ...
        cannot be rejected as they are strictly necessary to provide you with the services on our
        Website.
      </LegalParagraph>
      <LegalParagraph>
        You may also be able to set or amend your cookie preferences by managing your web browser
        settings. As each web browser is different, please consult the instructions provided by your
        web browser (typically in the "help" section). If you choose to refuse or disable cookies
        you may still use the Website, though some of the functionality of the Website may not be
        available to you.
      </LegalParagraph>

      <LegalSubheading>How Often Will We Update This Cookie Policy?</LegalSubheading>
      <LegalParagraph>
        We may update this Cookie Policy from time to time in order to reflect any changes to the
        cookies and related technologies we use, or for other operational, legal or regulatory
        reasons.
      </LegalParagraph>
      <LegalParagraph>
        Each time you use our Website, the current version of the Cookie Policy will apply. When you
        use our Website, you should check the date of this Cookie Policy (which appears at the top
        of this document) and review any changes since the last version.
      </LegalParagraph>

      <LegalSubheading>Where Can You Obtain Further Information?</LegalSubheading>
      <LegalParagraph>
        For any questions or concerns regarding our Cookie Policy, you may contact us using the
        following details:
      </LegalParagraph>
      <LegalParagraph>
        Kacper Ochmański
