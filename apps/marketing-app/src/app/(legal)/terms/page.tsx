  ...
  return (
    <LegalDocument>
      ...
      <LegalParagraph>
        ...
        and any related services provided by AsyncStatus.
      </LegalParagraph>
      <LegalParagraph>
        By accessing{" "}
        <LegalLink href="https://asyncstatus.com">
        ...
        using any other services provided by AsyncStatus.
      </LegalParagraph>
      <LegalParagraph>
        We, AsyncStatus, reserve the right to review and amend any of these
      ...
      <LegalParagraph>
        These Terms of Service were last updated on March 10, 2025.
      </LegalParagraph>
      ...
      <LegalParagraph>
        ...
        owned by or licensed to AsyncStatus and are protected by applicable
      ...
      <LegalParagraph>
        In no event shall AsyncStatus or its suppliers be liable for any
        ...
        on this website, even if AsyncStatus or an authorized representative has
      ...
      <LegalParagraph>
        ...
        general information purposes only. AsyncStatus does not warrant or make
      ...
      <LegalParagraph>
        AsyncStatus has not reviewed all of the sites linked to its website and
        is not responsible for the contents of any such linked site. The
        inclusion of any link does not imply endorsement, approval or control by
        AsyncStatus of the site. Use of any such linked site is at your own risk
      ...
      <LegalParagraph>
        ...
        the laws of Poland. You irrevocably submit to the exclusive jurisdiction
