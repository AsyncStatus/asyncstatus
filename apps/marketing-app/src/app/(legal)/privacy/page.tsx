...
export default function Page() {
  return (
    <LegalDocument>
      ...
      <LegalParagraph>
        Your privacy is important to us. It is AsyncStatus's policy to respect
        ...
        website,{" "}
        <LegalLink href="https://asyncstatus.com">
      ...
      <LegalParagraph>
        This policy is effective as of December 29, 2024
      </LegalParagraph>
      ...
      <LegalParagraph>
        ...
        our newsletter, when you register an account - which may include one or
      ...
      <LegalParagraph>
        ...
        organizations (known as "data processors"). We, AsyncStatus, located at
        the address provided in our Contact Us section, are a Data Controller
        and/or Processor with respect to the personal information you provide to
        us.
      </LegalParagraph>
      <LegalSmallHeading>
      ...
      <LegalParagraph>
        ...
        restrict the processing of your personal information if:
      </LegalParagraph>
      <ol type="i">
        <LegalListItem>
      ...
      <LegalParagraph>
        ...
        information to include any information about an individual, such as
        financial information, information about your appearance, your views and
        opinion (such as those expressed online or through a survey), opinions
        held about you by others, and any personal correspondences you may have
        with us. While this information may not directly identify you, be aware
      ...
      <LegalParagraph>
        ...
        Identifying Information (PII), any references to personal information
        and PII in this privacy policy, and in official communications from
        AsyncStatus, are intended as equivalent to one another in every way,
        shape and form.
      </LegalParagraph>
      ...
      <LegalParagraph>
        ...
        consent to your name and email address being used so we can respond to
        your enquiry. Under PIPEDA, consent is only valid if it is reasonable to
        expect that an individual to whom the organization's activities are
        directed would understand the nature, purpose, and consequences of the
        collection, use, or disclosure of the personal information to which they
        are consenting.
      </LegalParagraph>
      <LegalParagraph>
      ...
      <LegalParagraph>
        While AsyncStatus endeavors to keep, store and handle customer data
        within locations in Canada, it may use agents or service providers
        located in the United States (U.S.), European Economic Area (EEA) or
        United Kingdom (UK) to collect, use, retain and process personal
        information as part of providing services to you. While we use all
        reasonable efforts to ensure that personal information receives the same
        level of security in any other jurisdiction as it would in Canada,
        please be aware that privacy protections under U.S. laws may not be the
        same adequacy.
      </LegalParagraph>
      <LegalSmallHeading>Customer Data Rights</LegalSmallHeading>
      <LegalParagraph>
        Although PIPEDA does not contain an extensive set of consumer rights, it
        does grant consumers the right to:
      </LegalParagraph>
      <LegalList>
        <LegalListItem>
        ...
        <LegalListItem>
          ...
          organization hold about them (or, if this is not possible, delete the
      ...
      <LegalParagraph>
        Where you give us consent to collect and use your personal information
        for a specific purpose. Subject to some restrictions, you can, at any
        time, refuse to consent, or continue to consent to the collection, use
        or disclosure of their personal information by notifying us using the
        email address below in the "Contact Us" section. Withdrawal of consent
        may impact our ability to provide or continue to provide services.
      </LegalParagraph>
      <LegalParagraph>
      ...
      <LegalParagraph>
        PIPEDA gives you a general right to access the PII held by businesses
        subject to this law. Under PIPEDA, you need to make your access request
        in writing and pay a minimal fee of $30.00.
      </LegalParagraph>
      <LegalParagraph>
        If any organizational fees seem unjust, you have the right to complain
        about this. We retain the right to decide how we disclose the copies of
        your PII to you. We will take all necessary measures to fulfill your
        request in 30 days from receipt, otherwise we must inform you of our
      ...
      <LegalList>
        ...
        <LegalListItem>
          the time required to undertake consultations necessary to respond to
          the request would make it impractical to meet the time limit.
        </LegalListItem>
      </LegalList>
      <LegalParagraph>
        We can also extend the time limit for the length of time required to
        convert the personal information into an alternative format. In these
        circumstances, we will advise you of the delay within the first 30 days
        and explain the reason for it.
      </LegalParagraph>
      <LegalSmallHeading>Right of rectification under PIPEDA</LegalSmallHeading>
      <LegalParagraph>
        You may request a correction to any factual errors or omissions within
        your PII. We would ask you to provide some evidence to back up your
        claim. Under PIPEDA, an organization must amend the information, as
        required, if you successfully demonstrate that it's incomplete or
        inaccurate.
      </LegalParagraph>
      <LegalParagraph>
        You may contact us at any time, using the information provided in the
        Contact Us section of this privacy policy if you believe your PII on our
        systems is incorrect or incomplete.
      </LegalParagraph>
      <LegalParagraph>
        If we cannot agree on changing the information, you have the right to
        have your concerns recorded with the Office of the Privacy Commission of
        Canada.
      </LegalParagraph>
      <LegalSmallHeading>
      ...
      <LegalParagraph>
        This privacy policy complies with the PIPEDA's requirements and ten
        principles of privacy, which are as follows:
      </LegalParagraph>
      <ol type="1">
        <LegalListItem>
          <strong>Accountability.</strong> AsyncStatus is responsible for the
          PII under its control and will designate one or more persons to ensure
          organizational accountability for compliance with the ten principles
          of privacy under PIPEDA, whose details are included below. All
          personnel are accountable for the protection of customers' personal
          information.
        </LegalListItem>
        <LegalListItem>
          <strong>Identifying purposes.</strong> AsyncStatus identifies the
          purposes for which personal information is collected at or before the
          time the information is collected.
        </LegalListItem>
        <LegalListItem>
          <strong>Consent.</strong> Consent is required for AsyncStatus's
          ...
          customers access a product or service offered by us, consent is deemed
          to be granted. Express consent may be obtained verbally, in writing or
          through electronic means. Alternatively, consent may be implied
          through the actions of customers or continued use of a product or
          service following AsyncStatus's notification of changes.
        </LegalListItem>
        <LegalListItem>
          <strong>Limiting collection.</strong> Personal information collected
          will be limited to that which is necessary for the purposes identified
          by AsyncStatus.
        </LegalListItem>
        <LegalListItem>
          <strong>Limiting use, disclosure and retention.</strong> We will not
          use or disclose personal information for purposes other than those for
          which the information was collected, except with your consent or as
          required by law. We will retain personal information only for as long
          as is necessary to fulfill the purposes for collecting such
          information and compliance with any legal requirements.
        </LegalListItem>
        <LegalListItem>
          <strong>Accuracy.</strong> Personal information will be maintained by
          AsyncStatus in an accurate, complete and up-to-date format as is
          necessary for the purpose(s) for which the personal information was
          collected.
        </LegalListItem>
        <LegalListItem>
          <strong>Safeguards.</strong> We will protect personal information with
          security safeguards appropriate to the sensitivity of such
          information.
        </LegalListItem>
        <LegalListItem>
          <strong>Openness.</strong> We will make our policies and practices
        ...
        <LegalListItem>
          <strong>Customer access.</strong> We will inform customers of the
          existence, use and disclosure of their personal information and will
          provide access to their personal information, subject to any legal
          restrictions. We may require written requests for access to personal
          information and in most cases, will respond within 30 days of receipt
          of such requests. Customers may verify the accuracy and completeness
          of their personal information, and may request the personal
          information be corrected or updated, if appropriate.
        </LegalListItem>
        <LegalListItem>
          <strong>Challenging compliance.</strong> Customers are welcome to
          direct any questions or inquiries concerning our compliance with this
          privacy policy and PIPEDA requirements using the contact information
          provided in the Contact Us section of this privacy policy.
        </LegalListItem>
      </ol>
      <LegalSmallHeading>Cookie Compliance</LegalSmallHeading>
      <LegalParagraph>
        Our email interactions with our customers are compliant with Canadian
        Anti-Spam Legislation. The Company does not send unsolicited email to
        persons with whom we have no relationship. We will not sell personal
        information, such as email addresses, to unrelated third-parties. On
        occasion, your personal information may be provided to our third-party
        partners to administer the products and services you request from us.
      </LegalParagraph>
      <LegalParagraph>
        ...
        especially if you share any personal information with them.
      </LegalParagraph>
      <LegalParagraph>
        Please refer to our Cookie Policy for more information.
      </LegalParagraph>
      ...
      <LegalParagraph>
        To enquire about AsyncStatus's privacy policy, or to report violations
        of user privacy, you may contact us using the details in the Contact us
        section of this privacy policy.
      </LegalParagraph>
      <LegalParagraph>
      ...
      <LegalParagraph>
        ...
        organizations. However this is a qualified right; it is not absolute,
      ...
      <LegalList>
        ...
        <LegalListItem>
          ...
          consent has been withdrawn. AsyncStatus relies on consent to process
      ...
      <LegalList>
        <LegalListItem>
          ...
          AsyncStatus in electronic form; and
        </LegalListItem>
        <LegalListItem>
