...
export function TeamStatusUpdatesSummaryEmail(props: {
  preview: string;
    ...
    <Layout preview={props.preview}>
      ...
      <Section>
        ...
        <Heading as="h2" style={h2}>
          Team status summary for <strong>{props.organizationName}</strong>.
        </Heading>
...
TeamStatusUpdatesSummaryEmail.PreviewProps = {
  preview: "Your team status summary is ready",
  recipientName: "John Doe",
  organizationName: "AsyncStatus",
  generalSummary:
    "Strong progress on onboarding; deployment blocked by missing permission; morale steady.",
  userSummaries: [
    { content: "Alice completed auth refactor and is implementing rate limiting" },
    { content: "Bob progressed on UI onboarding; theming issues flagged" },
  ],
...
export default TeamStatusUpdatesSummaryEmail;
