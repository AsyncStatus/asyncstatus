...
export function GitlabActivitySummaryEmail(props: {
  preview: string;
    ...
    <Layout preview={props.preview}>
      ...
      <Section>
        ...
        <Heading as="h2" style={h2}>
          GitLab activity summary for <strong>{props.organizationName}</strong>.
        </Heading>
...
GitlabActivitySummaryEmail.PreviewProps = {
  preview: "Your GitLab activity summary is ready",
  recipientName: "John Doe",
  organizationName: "AsyncStatus",
  generalSummary: "High activity across projects with multiple MRs and a hotfix.",
  projectSummaries: [
    { content: "web-app: Completed onboarding UI; merged !124 and !128" },
    { content: "api: Hotfix !212 deployed; pipeline intermittency under investigation" },
  ],
  effectiveFrom: "2024-01-15T00:00:00Z",
  effectiveTo: "2024-01-22T00:00:00Z",
  viewUpdatesLink: "https://app.asyncstatus.com/acme/activity/gitlab",
};

export default GitlabActivitySummaryEmail;
