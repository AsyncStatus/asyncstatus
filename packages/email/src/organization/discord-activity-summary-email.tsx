...
export function DiscordActivitySummaryEmail(props: {
  preview: string;
    ...
    <Layout preview={props.preview}>
      ...
      <Section>
        ...
        <Heading as="h2" style={h2}>
          Discord activity summary for <strong>{props.organizationName}</strong>.
        </Heading>
        ...
        {props.channelSummaries.length > 0 && (
          <Section style={{ marginBottom: 32 }}>
            ...
            {props.channelSummaries.map((summary, index) => (
              <Text
                key={`discord-summary-${index}-${summary.content.slice(0, 20)}`}
...
DiscordActivitySummaryEmail.PreviewProps = {
  preview: "Your Discord activity summary is ready",
  recipientName: "John Doe",
  organizationName: "AsyncStatus",
  generalSummary: "Active collaboration on new features; moderation issue resolved quickly.",
  channelSummaries: [
    { content: "#dev-chat: Coordinated integration work; blockers identified for API limits" },
    { content: "#announcements: Release notes shared; next AMA scheduled" },
  ],
  effectiveFrom: "2024-01-15T00:00:00Z",
  effectiveTo: "2024-01-22T00:00:00Z",
  viewUpdatesLink: "https://app.asyncstatus.com/acme/activity/discord",
};

export default DiscordActivitySummaryEmail;
